...
int TA_HT_TRENDLINE_Lookback( void )
{
    ...
    */
   return 63 + TA_GLOBALS_UNSTABLE_PERIOD(TA_FUNC_UNST_HT_TRENDLINE,HtTrendline);
}
                            ...
                            double        outReal[] )
{
    ...
    */
   lookbackTotal = 63 + TA_GLOBALS_UNSTABLE_PERIOD(TA_FUNC_UNST_HT_TRENDLINE,HtTrendline);
